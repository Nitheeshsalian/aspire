    ...
    return (
        <React.Fragment>
            <View style={styles.greenCard}>
                ...
                <Text style={styles.cardNumberText}>{hideCard ? "5 6 4 7    3 4 1 1    2 4 1 3    2 0 2 0" :
                    "* * * *    * * * *    * * * *    2 0 2 0"}</Text>
                <Text style={styles.validityText}>Thru: 12/20     CVV:{hideCard ? " 4 5 6" : " * * *"}</Text>
            ...
            <TouchableOpacity style={styles.hideCardContent} onPress={toggleCard}>
                ...
                />
                <Text style={styles.hideText}>{hideCard ? "Hide card number" : "Show card number"}</Text>
            </TouchableOpacity>
        </React.Fragment >
    );
}
